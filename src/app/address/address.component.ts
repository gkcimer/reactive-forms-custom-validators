...
function CountryAddressTypeValidator(group: FormGroup): ValidationErrors | null {
  ...
  if (countryCtrl) {
    ...
    const isForeignAddress = isForeignAddressCtrl.value;

    if (country === 'US' && isForeignAddress) {
      return { countryAddressTypeMismatch: true };
    } else if (country !== 'US' && !isForeignAddress) {
      return { addressTypeCountryMismatch: true };
    }
  }
...
export class AddressComponent implements OnInit {
  ...
  adderessForm = new FormGroup({
      ...
      isForeignAddress: new FormControl(false, [Validators.required])
    },
  ...
  ngOnInit() {}
	...
	get state() { return <FormControl>this.adderessForm.get('state');}
	get zipCode() { return <FormControl>this.adderessForm.get('zipCode');}
	get country() { return <FormControl>this.adderessForm.get('country');}
	get isForeignAddress() { return <FormControl>this.adderessForm.get('isForeignAddress');}
